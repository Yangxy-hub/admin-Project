...
class Course extends Component {
  ...
  search = (searchName) => {
    ...
    this.props.getCourseList({ Coursename: searchName, page, limit }).finally(() => {
      this.setState({
        searchLoading: false,
      });
    });
      ...
      <div>
        ...
        <div className="course-table">
          ...
          <Table
            ...
            // 让表格水平方向可以滚动
            scroll={{ x: 1200 }}
            onChange = {(pagination, filters, sorters, sorter, extra) => {
              console.log('后台排序')
              console.log(pagination, filters, sorters, sorter, extra)
            }}
          />
        </div>
